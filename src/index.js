...
const { didMount, didUnmount } = (function getDidMountAndUnmount() {
    ...
    function initialize(THREE, componentName) {
        ...
        function undo() {
            console.log('undo function has been called!!');
            selected = temp_selected;
            selected.object3D.position.x = temp_x;
            selected.object3D.position.y = temp_y;
            selected.object3D.position.z = temp_z;
            repos();
            // positionLog.pop({
            // 	position: Object.assign({}, nextPosition),
            // 	time: performance.now()
            ...
            // var history_index =history.indexof()
        ...
        function redo() {
            console.log('redo function has been called!!');
            temp_selected = selected;
            temp_x = selected.object3D.position.x;
            temp_y = selected.object3D.position.y;
            temp_z = selected.object3D.position.z;
            repos()
        ...
        function onMouseDown({ clientX, clientY }) {
            ...
            if (element) {
                ...
                // for (let element of document.getElementsByClassName("left-bar-item")) {
                //     if (element.classList.contains('active__element')) {
                //         document.getElementsByClassName('sidebar')[0].style.left = '417px';
                //     } else {
                //         document.getElementsByClassName('sidebar')[0].style.left = '94px';
                //     }
                // }
                document.getElementsByClassName('sidebar')[0].style.display = 'flex';
                document.getElementById('effect-options').classList.add('d-none')
