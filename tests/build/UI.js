...
$('.audio_assets').click(function() {
    ...
    $.ajax(settings).done(function(response) {
        ...
        for (var i = 0; i < audResults.length; i++) {
            ...
            addToSceneBtn.setAttribute('data-source', audResults[i].previews['preview-lq-mp3']);
    ...
    $.ajax({
        method: 'post',
        url: 'http://pitchar.io/user/apis/_fetch-media.php',
        data: {
            submit: 1,
            authtoken: token
        },
...
document.getElementById('choosemarkerbut').addEventListener('click', function(e) {
    ...
    $.ajax({
        method: 'POST',
        url: 'http://pitchar.io/user/apis/_fetch_markers.php',
...
$(document).ready(function() {
    ...
    $.ajax({
        method: 'post',
        url: 'http://pitchar.io/user/apis/_fetch_assets.php',
        data: {
            submit: 1,
            authtoken: token
        },
